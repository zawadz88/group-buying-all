...
public class DatabasePasswordSecurerBean extends JdbcDaoSupport {
	...
	public void secureDatabase() {
		getJdbcTemplate().query("select username, password from employees", new RowCallbackHandler(){
			@Override
...
//				String encodedPassword = passwordEncoder.encodePassword(password, null);
				getJdbcTemplate().update("update emplyees set password = ? where username = ?", 
						encodedPassword, 
						username);
